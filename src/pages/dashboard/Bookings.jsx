      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 p-4 rounded-2xl bg-surface border border-border">
          <div className="relative flex-1 min-w-[150px] sm:min-w-[200px]">
            <Search
              size={16}
              className="absolute ltr:left-3 rtl:right-3 top-1/2 -translate-y-1/2 text-txt-muted pointer-events-none"
            />
            <Input
              value={search}
              onChange={(e) => {
                ...
                <thead>
                  <tr className="border-b border-border bg-surface-hover/50">
                    {[
                      ...
                      <th
                        key={col}
                        className="px-4 py-3 text-start font-semibold text-txt-muted text-xs whitespace-nowrap"
                      >
                        {col}
                      </th>
                    ))}
                  ...
                  {paginated.map((b, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-txt-muted">
                        {isRTL
                          ? b.departments?.name_ar || b.departments?.name_en
