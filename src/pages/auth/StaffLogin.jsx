      ...
      <div className="w-full max-w-md">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}
          ...
          <form onSubmit={handleLogin}>
            <div>
              <label className="block text-sm font-semibold text-gray-600 mb-1 flex items-center gap-1.5"><Mail size={14} /> Email *</label>
              <Input
                name="email"
                type="email"
                value={form.email}
            ...
            <div className="mt-4">
              <label className="block text-sm font-semibold text-gray-600 mb-1 flex items-center gap-1.5"><Lock size={14} /> Password *</label>
              <Input
                name="password"
                type="password"
                value={form.password}
